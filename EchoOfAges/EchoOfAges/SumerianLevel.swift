...
extension SumerianLevel {
    ...
    static let level1 = SumerianLevel(
        ...
        decodedMessage: "In the great above, AN was fixed and named. The first root of the great Tree pressed downward through the clay, seeking the dark waters below the world. Heaven was made real the moment it was written.",
        newGlyphs: [.an, .ki, .a],
        artifact: "𒀭",
    ...
    static let level2 = SumerianLevel(
        ...
        decodedMessage: "In the great below, KI was planted and known. The Moon measured its depths and found: what grows in the dark grows as surely as what grows in the light. The second root of the Tree was the root of time.",
        newGlyphs: [.ud],
        artifact: "𒌓",
    ...
    static let level3 = SumerianLevel(
        ...
        decodedMessage: "The branches of the Tree reach in both directions at once. As AN is above, KI is below. As the branch grows outward, the root grows inward. The priests of Nippur knew: the world is divided into invisible chambers, and all of them are full.",
        newGlyphs: [],
        artifact: "𒆳",
    ...
    static let level4 = SumerianLevel(
        ...
        decodedMessage: "What grows toward AN-GAL — the great heaven — also grows toward KI-GAL — the great earth. The ziggurat is the Tree made stone: seven roots descending, seven branches ascending, the middle level the world where people live. All growth has two directions. All things reach both ways.",
        newGlyphs: [.gal],
        artifact: "𒃲",
